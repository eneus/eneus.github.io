...
date: 2019-05-12
type: "blog"
tags: ["SSH", "books", "Tips & Tunnels"]
image: images/backgrounds/9.jpg
description : "SSH Examples, Tips & Tunnels"
---
...
11. Remote GUI Applications with SSH x11 Forwarding12. Copy files remotely with rsync and SSH
...
Each of the above a parameters are optional apart from the **remoteserver**.<p>
...
```
**warning** (netrw) cannot determine method 
...
Souurce: https://hackertarget.com/ssh-examples-tunnels/